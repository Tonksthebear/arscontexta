...
**Composition rules:**
- `the Ars Contexta plugin root/reference/derivation-validation.md` -- Test 4 (Multi-Domain Composition) validates the pattern
- `the Ars Contexta plugin root/reference/three-spaces.md` -- three-space architecture (shared across domains)
- `the Ars Contexta plugin root/reference/interaction-constraints.md` -- coherence validation for domain config

**Domain configuration:**
- `the Ars Contexta plugin root/reference/vocabulary-transforms.md` -- domain-native term mapping
- `the Ars Contexta plugin root/reference/tradition-presets.md` -- pre-validated domain configurations
- `the Ars Contexta plugin root/reference/use-case-presets.md` -- 3 presets with configurations
- `the Ars Contexta plugin root/reference/dimension-claim-map.md` -- research backing for dimension positions
- `the Ars Contexta plugin root/reference/failure-modes.md` -- domain vulnerability matrix
...
1-3 conversation turns to understand the new domain. Use one concise question and wait for the answer for each turn.
...
- Closest use-case preset from `the Ars Contexta plugin root/reference/use-case-presets.md`
- Cascade from system-level dimensions

### 3b. Build vocabulary mapping

Read `the Ars Contexta plugin root/reference/vocabulary-transforms.md` for the transformation table.
...
Read `the Ars Contexta plugin root/reference/derivation-validation.md` (Test 4: Multi-Domain Composition) for the validated composition pattern.
...
Run the new domain's configuration through `the Ars Contexta plugin root/reference/interaction-constraints.md`:
...
Create a domain-specific methodology document that loads when working in this domain. For Codex: `.claude/skills/[domain]-guide/SKILL.md` or a section in the context file. For other platforms: a standalone guide file.
