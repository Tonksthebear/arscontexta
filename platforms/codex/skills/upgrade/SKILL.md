---
name: upgrade
description: Apply plugin knowledge base updates to an existing generated system. Consults the Ars Contexta research graph for methodology improvements, proposes skill upgrades with research justification. Never auto-implements.
version: "1.0"
...
|------|------|------------------|
| Methodology graph | `the Ars Contexta plugin root/methodology/` | All content — filter by `kind:` field (research/guidance/example) |
| Reference docs | `the Ars Contexta plugin root/reference/` | WHAT — structured reference documents and dimension maps |
