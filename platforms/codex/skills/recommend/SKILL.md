---
name: recommend
description: Get research-backed architecture advice for your knowledge system. Describe your use case, constraints, and goals — get specific recommendations grounded in TFT research with rationale for each decision.
version: "1.0"
...
1. **`the Ars Contexta plugin root/reference/tradition-presets.md`** — tradition and use-case presets
   - Pre-validated coherence points in the 8-dimension space
   - Starting points for customization, not final answers

2. **`the Ars Contexta plugin root/reference/methodology.md`** — universal methodology principles

3. **`the Ars Contexta plugin root/reference/components.md`** — component blueprints (what can be toggled)

4. **`the Ars Contexta plugin root/reference/dimension-claim-map.md`** — maps each dimension position to supporting research claims

5. **`the Ars Contexta plugin root/reference/interaction-constraints.md`** — hard blocks, soft warns, cascade effects between dimensions

6. **`the Ars Contexta plugin root/reference/claim-map.md`** — topic navigation for the research graph
...
Read `the Ars Contexta plugin root/reference/tradition-presets.md`. This file contains:
...
Use `the Ars Contexta plugin root/reference/claim-map.md` to identify which research topics apply to the user's use case. Read the claim map and identify relevant topic clusters.
...
Read `the Ars Contexta plugin root/reference/dimension-claim-map.md`. This maps each dimension position to the research claims that support it.
...
Read `the Ars Contexta plugin root/reference/interaction-constraints.md`.
...
1. Read both presets from `the Ars Contexta plugin root/reference/tradition-presets.md`
