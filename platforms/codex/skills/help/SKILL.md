---
name: help
description: Contextual guidance and command discovery. Three modes — narrative (first-time), contextual (mid-task), compact (quick reference). Shows available commands, active skills, and intelligent suggestions based on vault state.
user-invocable: true
version: "1.0"
...
Scan `the Ars Contexta plugin root/skills/` dynamically:
