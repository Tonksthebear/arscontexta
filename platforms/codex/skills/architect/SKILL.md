...
|-----------|-----------------|-------------|
| `the Ars Contexta plugin root/reference/dimension-claim-map.md` | Which research claims inform which dimensions | Mapping friction to dimension adjustments |
| `the Ars Contexta plugin root/reference/interaction-constraints.md` | How dimension choices create pressure on others | Cascade analysis for proposed changes |
| `the Ars Contexta plugin root/reference/methodology.md` | Universal principles and processing pipeline | Grounding recommendations in first principles |
| `the Ars Contexta plugin root/reference/failure-modes.md` | 10 failure modes with domain vulnerability matrix | Connecting friction to known failure patterns |
| `the Ars Contexta plugin root/reference/tradition-presets.md` | Named points in configuration space | Alternative configurations to consider |
| `the Ars Contexta plugin root/reference/vocabulary-transforms.md` | Universal-to-domain term mapping | Ensuring output uses domain vocabulary |
| `the Ars Contexta plugin root/reference/three-spaces.md` | Self/notes/ops architecture and boundary rules | Three-space boundary analysis |
| `the Ars Contexta plugin root/reference/derivation-validation.md` | Validation tests for derived systems | Post-change validation criteria |
| `the Ars Contexta plugin root/reference/evolution-lifecycle.md` | Seed-evolve-reseed patterns, friction-driven adoption | When to evolve vs when to reseed |
| `the Ars Contexta plugin root/reference/self-space.md` | Agent identity generation and self/ architecture | Self-space related recommendations |
